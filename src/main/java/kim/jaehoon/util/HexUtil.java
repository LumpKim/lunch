...
public class HexUtil {
    ...
    private static final byte decodeHexChar(char var0) {
        int var2;
        if (var0 >= '0' && var0 <= '9') {
            var2 = var0 - 48;
        } else {
    ...
    public static final byte[] decodeHexString(String var0) {
        if (var0 == null) {
            return null;
        } else {
    ...
    public static final String toBitString(byte var0) {
    ...
    public static final String toBitString(int var0) {
        StringBuilder var2 = new StringBuilder();
    ...
    public static final void toBytes(long var0, byte[] var2, int var3, int var4) {
        if (var4 <= 0) {
            IllegalArgumentException var6 = new IllegalArgumentException("len should be positive integer");
            throw var6;
        } else {
    ...
    public static final String toHexString(byte[] var0, int var1, int var2, int var3) {
        if (var0 == null) {
            return null;
        } else {
            ...
            if (var4 >= var5) {
                ...
                IllegalArgumentException var7 = new IllegalArgumentException("buffer length is not enough");
                throw var7;
            }
        }
    }
    ...
    public static final String toHexString(int[] var0) {
        if (var0 == null) {
            ...
            for(int var1 = 0; var1 < var2; ++var1) {
                var3.append(String.format("%08x", var0[var1]));
                var3.append("  ");
            }
